  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8">
      ...
      <div className="text-center mb-8">
        <div className="mx-auto w-full max-w-2xl p-6 rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 text-white shadow-lg relative overflow-hidden">

          {/* Decorative Graphic */}
          <div className="absolute inset-0 opacity-15 bg-[url('/pattern.svg')] bg-cover bg-center"></div>

          <div className="relative flex flex-col items-center">
            <img src="/header-graphic.svg" alt="Teer Graphic" className="w-24 h-24 mb-3 opacity-90" />
      ...
      {/* Google Ad (Bottom) */}
      <div className="max-w-3xl mx-auto mt-8 bg-white shadow-md p-4 rounded-xl text-center text-sm text-gray-500 border border-blue-100">
